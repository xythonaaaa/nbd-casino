...
const RISKS = {
  low: {
    ...
    slices: [
      ...
      { mult: 0, color: '#374151', label: '0x', weight: 3 },
      { mult: 1.1, color: '#c084fc', label: '1.1x', weight: 2 },
      { mult: 1.2, color: '#a855f7', label: '1.2x', weight: 2 },
      { mult: 0, color: '#374151', label: '0x', weight: 3 },
      { mult: 1.3, color: '#9333ea', label: '1.3x', weight: 1.5 },
      { mult: 1.5, color: '#7e22ce', label: '1.5x', weight: 1.2 },
      { mult: 0, color: '#374151', label: '0x', weight: 3 },
      { mult: 2, color: '#6b21a8', label: '2x', weight: 0.6 },
      { mult: 3, color: '#581c87', label: '3x', weight: 0.25 },
    ],
  },
  medium: {
    label: 'Medium',
    slices: [
      { mult: 0, color: '#374151', label: '0x', weight: 4 },
      { mult: 0, color: '#374151', label: '0x', weight: 4 },
      { mult: 0, color: '#374151', label: '0x', weight: 3 },
      { mult: 1.2, color: '#e879f9', label: '1.2x', weight: 1.5 },
      { mult: 1.5, color: '#d946ef', label: '1.5x', weight: 1.2 },
      { mult: 0, color: '#374151', label: '0x', weight: 3 },
      { mult: 2, color: '#c026d3', label: '2x', weight: 0.9 },
      { mult: 3, color: '#a21caf', label: '3x', weight: 0.5 },
      { mult: 5, color: '#86198f', label: '5x', weight: 0.2 },
      { mult: 8, color: '#701a75', label: '8x', weight: 0.08 },
    ],
  },
  hard: {
    label: 'Hard',
    slices: [
      { mult: 0, color: '#374151', label: '0x', weight: 5 },
      { mult: 0, color: '#374151', label: '0x', weight: 5 },
      { mult: 0, color: '#374151', label: '0x', weight: 4 },
      { mult: 0, color: '#374151', label: '0x', weight: 4 },
      { mult: 0, color: '#374151', label: '0x', weight: 4 },
